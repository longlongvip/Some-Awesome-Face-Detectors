...
class Predict(object):
    ...
    def predict(self, image, resize_scale=1, score_threshold=0.8, top_k=100, NMS_threshold=0.3, NMS_flag=True,
...
def run_prediction_folder():
    ...
    for file_name in file_name_list:
        ...
        bboxes = my_predictor.predict(im, resize_scale=1, score_threshold=0.3, top_k=10000, NMS_threshold=0.3,
